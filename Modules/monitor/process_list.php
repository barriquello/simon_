...
<div style="font-size:30px; padding-bottom:20px; padding-top:18px"><b>Monitor <span id="monitorid"></span>:<span id="variableid"></span></b> config</div>
...
processlist_ui.monitorid = <?php echo $monitorid; ?>;
processlist_ui.variableid = <?php echo $variableid; ?>;

processlist_ui.monitors = monitor.getall();
...
$("#monitorid").html(processlist_ui.monitorid);
if (processlist_ui.monitors[processlist_ui.monitorid].decoder.variables[processlist_ui.variableid].name!=undefined) {
    $("#variableid").html(processlist_ui.monitors[processlist_ui.monitorid].decoder.variables[processlist_ui.variableid].name);
} else {
